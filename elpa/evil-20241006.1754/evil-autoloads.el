...
;;;***

;;;### (autoloads nil "evil-keybindings" "evil-keybindings.el" (0
;;;;;;  0 0 0))
;;; Generated autoloads from evil-keybindings.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-keybindings" '("evil--set-motion-state")))
...
;;;***

;;;### (autoloads nil nil ("evil-development.el" "evil-pkg.el" "evil.el")
;;;;;;  (0 0 0 0))
